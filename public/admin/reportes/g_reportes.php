    ...
    <form action="guardar_reporte.php" method="POST">
        ...
        <div class="signature-section">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nombre_solicitante" name="nombre_solicitante" value="<?php echo $docente['nombre'] . ' ' . $docente['apellido_p'] . ' ' . $docente['apellido_m']; ?>" readonly>
            </div>
            <div class="form-group">
        ...
        $('#npesonal').on('change', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#facultad').val(docente.id_facultad); // Asegúrate de tener select con id_facultad
                }
            });
        });
