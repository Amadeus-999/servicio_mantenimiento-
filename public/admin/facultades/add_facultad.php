...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $facultad = isset($_POST['facultad']) ? strtoupper(trim($_POST['facultad'])) : '';
            ...
            <div class="card">
                ...
                <form method="POST" action="add_facultad.php">
                    <div class="form-group">
                        <label for="facultad"><i class="fas fa-building"></i> Nombre de la Facultad
                            <span style="color: red;">*</span>
                        </label>
                        <input type="text" class="form-control" id="facultad" name="facultad" required style="text-transform: uppercase;">
                    </div>
